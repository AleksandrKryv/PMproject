...
from .models import PMuser, Photograph, Portfolio, Model, Album, Photo, Like
from django.views import generic
from django.views.generic import TemplateView
from .forms import PMuserForm, PhotographForm, Modelform, LoginForm, ExtendRegistrationForm, AlbumaddForm, PortfolioaddForm
